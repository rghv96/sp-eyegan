...
def main():
    ...
    if event_type == 'fixation':
        data = np.load(data_dir + 'fixation_matrix_gazebasevr_vd_' + stimulus + '.npy')
        save_path = model_dir + 'fixation_model_gazebasevr_' + stimulus
    elif event_type == 'saccade':
        data = np.load(data_dir + 'saccade_matrix_gazebasevr_vd_' + stimulus + '.npy')
        save_path = model_dir + 'saccade_model_gazebasevr_' + stimulus
