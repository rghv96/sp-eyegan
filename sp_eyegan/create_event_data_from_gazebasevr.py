...
def main():
    ...
    parser.add_argument('-target_sampling_rate', '--target_sampling_rate', type=int, default=250)
    ...
    if stimulus == 'video':
        ...
        use_trial_types = ['TEX']
    elif stimulus == 'vergence':
        use_trial_types = ['VRG']
    elif stimulus == 'pursuit':
        use_trial_types = ['PUR']
    elif stimulus == 'random':
        use_trial_types = ['RAN']
    elif stimulus == 'all':
        use_trial_types = ['TEX', 'VID', 'VRG', 'PUR', 'RAN']
    sac_window_size = args.sac_window_size
    fix_window_size = args.fix_window_size

    gaze_data_list, gaze_feature_dict, gaze_label_matrix, gaze_label_dict = data_loader.load_gazebasevr_data(
        gaze_base_vr_dir=config.GAZE_BASE_VR_DIR,
    ...
    np.save('data/fixation_matrix_gazebasevr_vd_' + stimulus, fixation_matrix)
    np.save('data/saccade_matrix_gazebasevr_vd_' + stimulus, saccade_matrix)
